...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0B1120] text-slate-100 flex flex-col justify-between relative overflow-hidden font-sans">
      {/* Decorative Glow Backdrops using Tailwind */}
        ...
        <div className="w-full max-w-md bg-slate-900/65 backdrop-blur-xl border border-slate-800/80 rounded-3xl p-8 shadow-2xl transition-all duration-300">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-slate-400 text-sm">
              Log in to continue your GATE prep dashboard.
            </p>
          </div>
          ...
          <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
            <div>
              ...
              <input 
                ...
                className="w-full bg-slate-950/40 border border-slate-800 rounded-xl px-4 py-3 text-sm text-slate-100 placeholder-slate-500 focus:outline-none focus:border-indigo-500/50 focus:ring-2 focus:ring-indigo-500/20 transition-all duration-200"
                required
              />
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <input 
                  ...
                  id="password" 
                  placeholder="••••••••"
                  className="w-full bg-slate-950/40 border border-slate-800 rounded-xl pl-4 pr-12 py-3 text-sm text-slate-100 placeholder-slate-500 focus:outline-none focus:border-indigo-500/50 focus:ring-2 focus:ring-indigo-500/20 transition-all duration-200"
                  required
                />
            ...
            <div className="flex items-center">
              <input 
                type="checkbox" 
                id="remember" 
                className="w-4 h-4 rounded border-slate-800 bg-slate-950/40 text-indigo-600 focus:ring-indigo-500/20 focus:ring-offset-slate-900 accent-indigo-600 cursor-pointer" 
              />
              <label 
                htmlFor="remember" 
                className="ml-2.5 text-xs text-slate-400 select-none cursor-pointer"
              >
          ...
          <div className="flex items-center my-6">
            ...
            <span className="text-[10px] font-semibold text-slate-500 uppercase tracking-widest px-4">Or continue with</span>
            <div className="flex-1 h-px bg-slate-800/80"></div>
          </div>
          ...
          <div className="text-center mt-8 text-xs text-slate-400">
            ...
            <Link href="/signup" className="text-teal-400 font-semibold hover:text-teal-300 transition-colors ml-1">
              Create Account
            </Link>
          </div>
        </div>
